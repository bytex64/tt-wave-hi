...
module pattern1_1(
  ...
  reg [3:0] note_sequence [15:0];

  initial begin
    note_sequence[0]  = N_C2;
    note_sequence[1]  = 0;
    note_sequence[2]  = 0;
    note_sequence[3]  = N_C2;
    note_sequence[4]  = 0;
    note_sequence[5]  = 0;
    note_sequence[6]  = N_C2;
    note_sequence[7]  = 0;
    note_sequence[8]  = 0;
    note_sequence[9]  = 0;
    note_sequence[10] = N_As1;
    note_sequence[11] = 0;
    note_sequence[12] = N_As1;
    note_sequence[13] = 0;
    note_sequence[14] = N_As1;
    note_sequence[15] = N_C2;
  end

  always @(*)
    note = note_sequence[select];
endmodule
...
module pattern1_2(
  ...
  initial begin
    note_sequence[0]  = N_Gs1;
    note_sequence[1]  = 0;
    note_sequence[2]  = 0;
    note_sequence[3]  = N_Gs1;
    note_sequence[4]  = 0;
    note_sequence[5]  = 0;
    note_sequence[6]  = N_Gs1;
    note_sequence[7]  = 0;
    note_sequence[8]  = 0;
    note_sequence[9]  = 0;
    note_sequence[10] = N_Fs1;
    note_sequence[11] = 0;
    note_sequence[12] = N_Fs1;
    note_sequence[13] = 0;
    note_sequence[14] = N_Fs1;
    note_sequence[15] = N_Gs1;
  end
...
module pattern1_3(
  ...
  initial begin
    ...
    note_sequence[6]  = N_Gs1;
    note_sequence[7]  = 0;
    note_sequence[8]  = N_As1;
    note_sequence[9]  = 0;
    note_sequence[10] = 0;
    note_sequence[11] = N_As1;
    note_sequence[12] = 0;
    note_sequence[13] = 0;
    note_sequence[14] = N_B1;
    note_sequence[15] = 0;
  end
...
module pattern3_2(
  ...
  initial begin
    note_sequence[0] = N_C2;
    note_sequence[1] = N_C2;
    note_sequence[2] = N_C2;
    note_sequence[3] = N_C2;
    note_sequence[4] = N_C2;
    note_sequence[5] = N_C2;
    note_sequence[6] = N_C2;
    note_sequence[7] = N_C2;
    note_sequence[8] = N_C2;
    note_sequence[9] = N_C2;
    note_sequence[10] = N_C2;
    note_sequence[11] = N_As1;
    note_sequence[12] = N_As1;
    note_sequence[13] = N_As1;
    note_sequence[14] = N_A1;
    note_sequence[15] = N_Gs1;
  end
...
module pattern3_4(
  ...
  initial begin
    note_sequence[0]  = N_Gs1;
    note_sequence[1]  = N_Gs1; 
    note_sequence[2]  = N_Gs1;
    note_sequence[3]  = N_Gs1;
    note_sequence[4]  = N_Gs1;
    note_sequence[5]  = N_Gs1;
    note_sequence[6]  = N_Fs1;
    note_sequence[7]  = N_Fs1;
    note_sequence[8]  = N_Gs1;
    note_sequence[9]  = N_Gs1;
    note_sequence[10] = N_Gs1;
    note_sequence[11] = N_Fs1;
    note_sequence[12] = N_Gs1;
    note_sequence[13] = N_Gs1;
    note_sequence[14] = N_As1;
    note_sequence[15] = N_As1;
  end
...
module pattern4_2(
  ...
  always @(*)
    note = select[1:0] == 0 ? N_C4 : (select[1:0] == 2 ? N_B7 : 0);
endmodule
